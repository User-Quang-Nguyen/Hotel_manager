...
<?php
    ...
    $query1 = "UPDATE hoadon SET trangthai='Đã thanh toán', tg_giaodich=CURRENT_TIMESTAMP WHERE mahoadon='$mahoadon'";
    ...
    <!-- <br><br><br><br><br><br> -->
        ...
        <label> Ngày lấy phòng : <?php echo $row['tg_traphong']; ?></label><br>
