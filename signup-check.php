...
if (isset($_POST['uname']) && isset($_POST['password'])
	...
	if (empty($uname)) {
	    ...
	    $sql1 = "SELECT * FROM khachhang WHERE uname='$uname'";
		$result1 = pg_query($conn, $sql1);
		$sql2 = "SELECT * FROM khachhang WHERE sdt='$sdt'";
		...
		if (pg_num_rows($result1) > 0) {
           ...
           $sql3 = "INSERT INTO khachhang(hovaten,gioitinh,ngaysinh, uname, pass,sdt) VALUES('$name','$gioitinh','$ngaysinh', '$uname','$pass', $sdt )";
