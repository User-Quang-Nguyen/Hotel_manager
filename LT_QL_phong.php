...
<?php 
    $query = "select * from phong natural join loaiphong order by phong_id";
...
echo "<div padding-top: 20px>";
    ...
    while($row = pg_fetch_assoc($result)){
        echo "<tr>";
          ...
          echo "<td align='left' width='200'>" . $row['ten'] . "</td>";
          echo "<td align='left' width='200'>" . $row['dientich'] ." m2". "</td>";
          echo "<td align='left' width='200'>" . $row['tienich'] . "</td>";
          if($row['trangthai'] == 'Bận'){
            ?>
              <td style="align='center' width='200'"><a href="LT_xemphong.php?phongid=<?php echo $row['phong_id']; ?>"><button type="button" class="btn btn-success">Xem phòng</button></a></td>
                ...
                echo "<td align='left' width='200'>" . "Trống" ."</td>";
              }
              echo "</tr>";
    }
    echo "</table>";
