...
<body>
    <div class="table-actor">
        <?php
            $id=$_SESSION['id'];
            $sql = "SELECT phong.phong_id,loaiphong.giaphong,thuephong.tg_datphong,thuephong.tg_layphong,thuephong.tg_traphong
            FROM thuephong NATURAL JOIN phong NATURAL JOIN loaiphong WHERE thuephong.tg_layphong>=CURRENT_TIMESTAMP ";
