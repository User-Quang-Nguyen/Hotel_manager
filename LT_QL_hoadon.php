...
<?php
    ...
    if(isset($_POST['loc'])){
      ...
      if(!empty($loc)){
          $query .= " WHERE trangthai='$loc'";
      }
  }
    $query .=" ORDER BY tg_giaodich desc";
    $result = pg_query($conn,$query);
    ?>
    <form style="margin-top: 20px;text-align: center;" action="LT_QL_hoadon.php" method="post" style="text-align: center; margin-bottom: 8px;">
    <select name="loc" style="padding: 4px;">
...
<?php
    ...
    while($row = pg_fetch_assoc($result)){
        ...
        echo "<tr>";
          ...
          echo "<td align='left' width='200'>" . $row['tg_traphong'] . "</td>";
